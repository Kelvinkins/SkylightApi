...
namespace Skylight.Data
{
    ...
    public class Glob
    {
        ...
        private UnitOfWork service;

        public Glob(UnitOfWork _service)
        {
            service = _service;
        }
        public static DateTime SkylightDateTime()
        {
        ...
        {
            int age = 0;
            age = Glob.SkylightDateTime().Year - dateOfBirth.Year;
            if (Glob.SkylightDateTime().DayOfYear < dateOfBirth.DayOfYear)
                age = age - 1;
